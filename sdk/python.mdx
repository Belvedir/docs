---
title: "Python SDK"
description: "Trace Python agents with the belvedir-loop package."
sidebarTitle: "Python"
---

Python agents use `belvedir-loop` — the same concepts as the Node SDK, with context managers instead of callbacks. It auto-instruments the installed `anthropic` / `openai` / LangChain / LlamaIndex packages. (The legacy `fractal-loop` package still works but is deprecated.)
