---
title: "Deploying Fractal-Instrumented Next.js Apps on Vercel"
sidebarTitle: "Vercel"
description: "Configure the Node.js runtime and set your environment variables on Vercel so Fractal SDK traces are captured correctly in production."
---
