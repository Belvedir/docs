...
Spans arrive with the session id, model, prompt, completion, and token counts, for streamed and unstreamed calls alike. Tasks, task groups, and [outcome reporting](/api-reference/outcomes) work exactly as with any other client.
