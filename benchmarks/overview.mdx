...
Benchmark runs are currently free: only inference is billed. Your organization's balance and pay-as-you-go settings live under **Organization Settings → Billing**.
