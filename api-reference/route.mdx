...
# ?format=json      → one {"object":"list","batch_id":"...","status":"...","data":[...]} envelope

# List the project's recent batches (the 50 most recent, newest first;
# the Anthropic SDK facade's list paginates with limit/after_id/before_id)
