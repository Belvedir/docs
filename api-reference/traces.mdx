...
description: "Send OpenTelemetry trace data to Belvedir in OTLP JSON format. This endpoint powers the trace analysis dashboard and is called automatically by the SDK."
---
