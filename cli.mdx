...
# --synthesize holds one request open for the whole pass (6–10 minutes) and needs @belvedir/cli 0.3.9 or newer;
# older versions print "read ETIMEDOUT" or "fetch failed" partway through while the environment still lands — re-run to pick it up.
