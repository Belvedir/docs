...
<Tip>
Working with a coding agent? This whole guide lives at [platform.belvedir.ai/agents.md](https://platform.belvedir.ai/agents.md) in agent-readable markdown. The dashboard's Home page has a **Copy Prompt** button that puts a ready-made instruction on your clipboard. Paste it into your coding agent and it fetches that page and instruments the app for you.
</Tip>
